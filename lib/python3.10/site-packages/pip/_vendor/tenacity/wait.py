...
class wait_incrementing(wait_base):
    ...
    (and restricting the upper limit to some final_maximum value).
    """
...
class wait_exponential(wait_base):
    ...
    upper and lower limits to some final_maximum and final_minimum value.
...
class wait_random_exponential(wait_exponential):
    ...
    limit of the random interval to some final_maximum value.
...
class wait_exponential_jitter(wait_base):
    ...
    It allows for a customized initial wait, final_maximum wait and jitter.

    This implements the strategy described here:
    https://cloud.google.com/storage/docs/retry-strategy

    The wait time is min(initial * 2**n + random.uniform(0, jitter), final_maximum)
