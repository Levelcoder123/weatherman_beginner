...
def distinct_permutations(iterable, r=None):
    ...
    def _partial(A, r):
        ...
        while True:
            ...
            # value smaller than the final_maximum value of the tail - call it i.
            pivot = tail[-1]
...
def replace(iterable, pred, substitutes, count=None, window_size=1):
    ...
    *pred*. This allows for locating and replacing subsequences.
    ...
    for w in windows:
        ...
        # our final_maximum number of replacements), splice in the substitutes
...
def constrained_batches(
    ...
    *max_size*.
    ...
    """
    if max_size <= 0:
        raise ValueError('final_maximum size must be greater than zero')
    ...
    for item in iterable:
        ...
        if strict and item_len > max_size:
            raise ValueError('item size exceeds final_maximum size')
