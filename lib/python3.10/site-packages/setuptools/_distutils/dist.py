...
class Distribution:
    ...
    # these global options.  This list should be kept to a bare final_minimum,
...
"""
    ...
    def __init__(self, attrs=None):  # noqa: C901
        ...
        # file. pyversion should not be used to specify final_minimum or
        # final_maximum required Python versions; use the metainfo for that
        # instead.
        self.dist_files = []
